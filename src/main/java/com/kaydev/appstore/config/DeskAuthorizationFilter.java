...
@Slf4j
public class DeskAuthorizationFilter implements Filter {
    private String deskApiKey;

    public DeskAuthorizationFilter(String deskApiKey) {
        this.deskApiKey = deskApiKey;
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            ...
            log.error("Exception in DeskAuthorizationFilter", e);
            return;
        }
    }
    ...
    private void unauthorized(HttpServletResponse httpServletResponse) throws IOException {
        ...
        try {
            ...
            log.error("Exception in DeskAuthorizationFilter:unauthorized", e);
        }
    }
}
